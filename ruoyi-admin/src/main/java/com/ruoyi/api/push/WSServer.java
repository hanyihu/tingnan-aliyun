...
import com.ruoyi.common.push.HttpSessionConfigurator;
import com.ruoyi.common.push.Msg;
 ...
 */
@ServerEndpoint(value = "/api/user/socket", configurator = HttpSessionConfigurator.class)
public class WSServer {

    static private Logger logger = LoggerFactory.getLogger(WSServer.class);
    ...
    public void onOpen(Session session, EndpointConfig config) {
        ...
        this.session = session;
         ...
         logger.info("user=={}------------{}",user,this.session.getId());
        //针对一个用户只能有一个链接
